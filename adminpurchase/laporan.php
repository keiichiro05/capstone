                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="bg-blue">ID_TRANSAKSI</th>
                                        ...
                                        <tbody>
										<?php 
                                        $show=mysqli_query($mysqli, "SELECT DISTINCT * from transaksi where status='4' GROUP BY id_supplier");
										$i=0;
										...
										$status='<span class="label label-danger">Not Completed</span>';
                                            ...
                                            echo "<tr>
												...
												<td>".$totharga."</td>
												<td>".$status."</td>
												<td><a href=\"ijinpesan.php?p=$id&&a=fin\"><button class=\"btn btn-info btn-flat\">Finish</button></a></td>
                                            </tr>";
                                             }?>
                                        </tbody>
                                        <!-- <tfoot>
